...
Автообновление страницы не реализовано! Обнвляем вручную (F5 или Ctrl-R).
...
- Нужен рефакторинг, логику форм можно перенести в отдельные файлы, нужны тесты
  и прочее. Сильно не заморачивался со всем этим.
